...
## Instructions
- First you need to create a person class that is initialized with a name that cannot be changed. #Done
- Each instance of class `Person`should be able to remember their name #Done
- Each instance of  class `Person` should start with $25 in their bank accounts #Done
- Each instance of  class `Person` should start with eight happiness points #Done
- Each instance of  class `Person` should start with eight hygiene points #Done
- The happiness and hygiene points should be able to change, however the maximum and minimum points for both happiness and hygiene should be 10 and  0 respectively #Done
- The amount in the bank account should also be able to change, though it has no max or min. #Done
